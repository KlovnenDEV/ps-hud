...
local function loadSettings()
    ...
    exports['qbr-core']:Notify(9, Lang:t("notify.hud_settings_loaded"), 5000, 0, 'hud_textures', 'check', 'COLOR_WHITE')
    Wait(1000)
...
local function HandleSetupResource()
    exports['qbr-core']:TriggerCallback('hud:server:getRank', function(isAdminOrGreater)
...
local function restartHud()
    ...
    -- exports['qbr-core']:Notify(Lang:t("notify.hud_restart"), "error")
    exports['qbr-core']:Notify(9, Lang:t("notify.hud_restart"), 5000, 0, 'hud_textures', 'check', 'COLOR_WHITE')
    Wait(1500)
    ...
    exports['qbr-core']:Notify(9, Lang:t("notify.hud_start"), 5000, 0, 'hud_textures', 'check', 'COLOR_WHITE')
    SendNUIMessage({
        action = 'menu',
        topic = 'restart',
    })
...
RegisterCommand('+engine', function()
    ...
    if GetIsVehicleEngineRunning(vehicle) then
        ...
        exports['qbr-core']:Notify(9, Lang:t("notify.engine_off"), 5000, 0, 'hud_textures', 'check', 'COLOR_WHITE')
    else
        -- exports['qbr-core']:Notify(Lang:t("notify.engine_on"))
        exports['qbr-core']:Notify(9, Lang:t("notify.engine_on"), 5000, 0, 'hud_textures', 'check', 'COLOR_WHITE')
    end
